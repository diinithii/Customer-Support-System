...
public class FaqDTO {
    ...
    public static FaqDTO fromEntity(Faq faq) {
        ...
        if (faq.getCreatedBy() != null) {
            ...
            dto.setCreatedByName(faq.getCreatedBy().getFirstname() + " " + faq.getCreatedBy().getLastname());
        }

        if (faq.getUpdatedBy() != null) {
            dto.setUpdatedById(faq.getUpdatedBy().getId());
            dto.setUpdatedByName(faq.getUpdatedBy().getFirstname() + " " + faq.getUpdatedBy().getLastname());
        }
